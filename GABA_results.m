...
% 
% 1) prepares an outcome structure GABA_results
%       - one row per participant
%       - one field per outcome measure
% 
% ----- DATA EXTRACTION -----
% Extracts outcome measures from all available datasets 
% 2) TEPs
% 3) RS-EEG
% 4) MEPs
% 
...
for p = 1:length(participant)
    % subject info
    GABA_results(p).subject.age = ; 
    GABA_results(p).subject.sex = ;
